...
get_presence <- function(a_line_list){
  if (TRUE %in%  stri_detect_fixed(linelist, "Left")) {
    student_presence <- "Left Early"
  } else if (TRUE %in%  stri_detect_fixed(linelist, "Present")) {
    student_presence <- "Present"
  } else if (TRUE %in%  stri_detect_fixed(linelist, "Absent")) {
    student_presence <- "Absent"
  } else if (TRUE %in%  stri_detect_fixed(linelist, "Late")) {
    student_presence <- "Late"
  }
}

# Function to extract the date from a linelist of strings
get_date <- function(a_line_list){
  a_line_list[length(a_line_list)]
}
